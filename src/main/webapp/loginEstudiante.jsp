          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="p-5">
                ...
                <form class="user" action="loginEstudiante" method="post">
                  <div class="form-group">
                    <input type="number" class="form-control form-control-user"
                           id="matriculaLogin" name="matriculaLogin" aria-describedby="emailHelp"
                           placeholder="Ingresa tu matricula" required>
                  </div>
                  <div class="form-group">
                    <input type="password" class="form-control form-control-user"
                           id="contraseñaEstudiante" name="contraseñaEstudiante" placeholder="Contraseña" required>
                  </div>
                  <div class="form-group">
                ...
                <hr>
                <div class="text-center">
                  <a class="small" href="registroDeEstudiante.jsp">¡Crea un cuenta!</a>
                </div>
              </div>
            </div>
          </div>
